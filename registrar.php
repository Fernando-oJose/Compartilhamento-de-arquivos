<?php
	...
	if (isset($_POST['criar'])) {
		...
		if ($do_email_check >= 1) {
			...
			echo '<h3>Escreve a tua matricula corretamente, deve ter 10 caracteres!</h3>';
			...
			echo '<h3>Escreve a sigla do curso corretamente, deve ter 3 caracteres!</h3>';
		}else{
	...
	<h2>Cria a tua conta</h2>
		...
		<fieldset>	
				...
				<input type="curso" placeholder="Curso (Discente) ou Instituto (Docente)" name="curso"><br />
       	    	 	 ...
       	    	 	 <p>
				<select name="cidades" style="width:300px">
               	        		<option value=""></option>
                			<option value="prof">Professor</option>
                    			<option value="sa">Aluno</option>
